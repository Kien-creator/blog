          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <div>
                ...
                <h3 class="mb-0">{{ pendingPosts.length }}</h3>
              </div>
              ...
              <tr v-for="post in pendingPosts" :key="post.id">
                ...
                <td>
                  <div class="btn-group btn-group-sm">
                    ...
                    <button @click="toggleFeature(post.id, !post.isFeatured)" class="btn btn-info">
                      <i :class="post.isFeatured ? 'bi bi-star-fill' : 'bi bi-star'"></i>
                    </button>
                  </div>
                </td>
              </tr>
